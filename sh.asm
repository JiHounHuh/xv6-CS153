...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    if(fork1() == 0){
     ...
     1ea:	0f 84 35 01 00 00    	je     325 <runcmd+0x175>
    if(fork1() == 0){
     1f0:	e8 9b ff ff ff       	call   190 <fork1>
     1f5:	85 c0                	test   %eax,%eax
     1f7:	0f 84 f0 00 00 00    	je     2ed <runcmd+0x13d>
    close(p[0]);
