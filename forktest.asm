  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  6d:	eb 0e                	jmp    7d <forktest+0x2d>
  6f:	90                   	nop
    if(pid == 0)
  70:	74 7a                	je     ec <forktest+0x9c>
  for(n=0; n<N; n++){
  72:	83 c3 01             	add    $0x1,%ebx
  75:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
  7b:	74 4b                	je     c8 <forktest+0x78>
    pid = fork();
  7d:	e8 d8 02 00 00       	call   35a <fork>
    if(pid < 0)
  ...
  97:	78 5f                	js     f8 <forktest+0xa8>
  for(; n > 0; n--){
  99:	83 eb 01             	sub    $0x1,%ebx
  9c:	75 f2                	jne    90 <forktest+0x40>
  9e:	66 90                	xchg   %ax,%ax
  if(wait() != -1){
  a0:	e8 c5 02 00 00       	call   36a <wait>
  a5:	83 f8 ff             	cmp    $0xffffffff,%eax
  a8:	75 6e                	jne    118 <forktest+0xc8>
  printf(1, "fork test OK\n");
  aa:	c7 44 24 04 36 04 00 	movl   $0x436,0x4(%esp)
  b1:	00 
  b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b9:	e8 62 ff ff ff       	call   20 <printf>
}
  ...
  write(fd, s, strlen(s));
  c8:	c7 04 24 44 04 00 00 	movl   $0x444,(%esp)
  cf:	e8 ec 00 00 00       	call   1c0 <strlen>
  d4:	c7 44 24 04 44 04 00 	movl   $0x444,0x4(%esp)
  db:	00 
  dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e3:	89 44 24 08          	mov    %eax,0x8(%esp)
  e7:	e8 96 02 00 00       	call   382 <write>
    exit(0);
  ec:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  f3:	e8 6a 02 00 00       	call   362 <exit>
      printf(1, "wait stopped early\n");
  f8:	c7 44 24 04 0f 04 00 	movl   $0x40f,0x4(%esp)
  ff:	00 
 100:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 107:	e8 14 ff ff ff       	call   20 <printf>
      exit(-1);
 10c:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
 113:	e8 4a 02 00 00       	call   362 <exit>
    printf(1, "wait got too many\n");
 118:	c7 44 24 04 23 04 00 	movl   $0x423,0x4(%esp)
 11f:	00 
 120:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 127:	e8 f4 fe ff ff       	call   20 <printf>
    exit(-1);
 12c:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
 133:	e8 2a 02 00 00       	call   362 <exit>
